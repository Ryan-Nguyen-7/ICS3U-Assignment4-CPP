        ...
        widthAsNumber > 0 && heightAsNumber > 0) {
            ...
            if (weightAsNumber < 27) {
                ...
                if (lengthAsNumber*widthAsNumber*heightAsNumber < 10000) {
                    std::cout << "We will accept your package!";
                } else {
                std::cout << "Volume must not exceed 10 000cm³";
            } else {
                std::cout << "Weight must not exceed 27kg";
        } else {
            std::cout << "Dimensions and weight must be positive";
        }
